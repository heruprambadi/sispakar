...
class Main extends CMS_Controller
{
    ...
    public function register()
    {
        ...
        $crud->set_table(cms_table_name('user'));
        ...
        $crud->edit_fields('user_name', 'password', 'email', 'real_name', 'alamat', 'sex', 'riwayat_penyakit');
        $crud->add_fields('user_name', 'password', 'email', 'real_name', 'alamat', 'sex', 'riwayat_penyakit');
        $crud->field_type('active', 'true_false');
        $crud->field_type('sex','true_false',
            array('0' => 'Wanita', '1' => 'Pria'));
        ...
        $crud->display_as('user_name', $this->cms_lang('User Name'))
            ...
            ->display_as('sex', $this->cms_lang('Jenis Kelamin'))
        ...
        $this->view('main/main_register', $output, 'main_register');
    }
    ...
    public function change_profile()
    {
        ...
        $SQL   = "SELECT user_name, email, real_name FROM ".cms_table_name('user')." WHERE user_id = " . $this->cms_user_id();
    ...
    public function user()
    {
        ...
        $crud->columns('user_name', 'email', 'real_name', 'active', 'groups');
        $crud->edit_fields('user_name', 'email', 'password', 'real_name', 'active', 'alamat', 'sex', 'pekerjaan', 'no_tlp', 'tanggal', 'riwayat_penyakit', 'groups');
        $crud->add_fields('user_name', 'email', 'password', 'real_name', 'active', 'alamat', 'sex', 'pekerjaan', 'no_tlp', 'tanggal', 'riwayat_penyakit', 'groups');
        $crud->field_type('active', 'true_false');
        $crud->field_type('sex','true_false',
            array('0' => 'Wanita', '1' => 'Pria'));
    ...
    public function group()
    {
        ...
        $crud->set_relation_n_n('users', cms_table_name('main_group_user'), cms_table_name('user'), 'group_id', 'user_id', 'user_name');
